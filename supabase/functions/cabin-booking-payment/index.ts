...
async function verifyCabinBookingPayment(request: Omit<VerifyPaymentRequest, 'action'>) {
  try {
    ...
    // Note: Transaction is now created automatically by the handle_cabin_payment_completion trigger
    // with proper deposit breakdown using the process_cabin_payment function
