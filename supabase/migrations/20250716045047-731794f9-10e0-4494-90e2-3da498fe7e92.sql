-- Drop and recreate get_active_popup_notifications function with duration_seconds
DROP FUNCTION IF EXISTS public.get_active_popup_notifications(uuid, text);
