...
CREATE TABLE public.news_posts (
  ...
  image_url TEXT,
  video_url TEXT,
  visible_to USER_DEFINED NOT NULL DEFAULT 'both',
  status TEXT NOT NULL DEFAULT 'active',
  created_at TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(),
  updated_at TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()
);

-- Create enum for news visibility
CREATE TYPE public.news_visibility AS ENUM ('user', 'merchant', 'both');
ALTER TABLE public.news_posts ALTER COLUMN visible_to TYPE news_visibility USING visible_to::news_visibility;
