...
BEGIN
  ...
  IF EXISTS (
    SELECT 1 FROM study_hall_reviews 
...
-- Trigger to validate review eligibility
CREATE TRIGGER validate_review_eligibility_trigger
  BEFORE INSERT OR UPDATE ON public.study_hall_reviews
  FOR EACH ROW
...
BEGIN
  ...
  WHERE b.user_id = p_user_id
    ...
    AND b.end_date >= CURRENT_DATE - INTERVAL '90 days'
