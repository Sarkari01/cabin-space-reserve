-- Drop and recreate the cabin payment processing function to handle deposit amounts
DROP FUNCTION IF EXISTS public.process_cabin_payment(uuid, numeric, text, text, jsonb);
